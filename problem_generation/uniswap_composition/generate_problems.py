...
#- /home/kb742/mev-adaptive-sampling/eth_token_tests_uniswapv2/0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc/14953917
...
for problem in common_problems:
    ...
    uniswapv3_filename = '/home/kb742/mev-adaptive-sampling/eth_token_tests_uniswapv3/{}/{}/amm_reduced'.format(uniswav3_address, block_number)

    transactions = merge(uniswapv3_filename, '{}/amm_reduced'.format(problem))
    outfile = '/home/kb742/mev-adaptive-sampling/eth_token_tests_uniswap_composition/{}/{}/amm_reduced'.format(uniswapv2_address, block_number)
