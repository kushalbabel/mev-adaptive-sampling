...
# TRANSACTIONS='/home/gid-javaheripim/clienttests_sushi/'
TRANSACTIONS='/home/kb742/mev-adaptive-sampling/clienttests_agg'
...
python optimize.py -t $TRANSACTIONS -d $DOMAIN --reorder --n_iter 5 --num_samples 5 --parents_portion 0.0 --p_swap_max 0.8 --p_swap_min 0.1 --num_samples_gauss 10
# python optimize.py -t $TRANSACTIONS -d $DOMAIN --reorder --n_iter 30 --num_samples 20 --u_random_portion 1. --parents_portion 0. --early_stopping 1000
