...
TRANSACTIONS='/home/kb742/mev-adaptive-sampling/eth_token_tests_uniswapv3/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48/15001234'
...
python optimize.py -t $TRANSACTIONS -d $DOMAIN --reorder --n_iter 1 --num_samples 5 --parents_portion 0.0 --p_swap_max 0.8 --p_swap_min 0.1 --num_samples_gauss 44 --dexes sushiswap uniswapv2
