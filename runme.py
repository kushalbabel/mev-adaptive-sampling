...
with open('artifacts_smooth_uniswapv2_updatedTX/info_summary.yaml', 'r') as f:
...
for k in sorted_keys:
    ...
    if os.path.isfile(TRANSACTION):
        command = f'python optimize.py -t {TRANSACTION} -d {DOMAIN} --reorder --n_iter 5 --num_samples 10 --parents_portion 0.0 --p_swap_max 0.8 --p_swap_min 0.1 --num_samples_gauss 40 --n_parallel_gauss 40'
        os.system(command)
...
for eth_pair in os.listdir(path_to_problems): 
    ...
    if os.path.exists(DOMAIN):
        command = f'python optimize.py -t {TRANSACTIONS} -d {DOMAIN} --reorder --n_iter 5 --num_samples 10 --parents_portion 0.0 --p_swap_max 0.8 --p_swap_min 0.1 --num_samples_gauss 40 --n_parallel_gauss 40'
